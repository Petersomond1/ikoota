// // ikootaapi/server.js
// // ENHANCED SERVER CONFIGURATION - Server startup and monitoring only
// // Route mounting is handled in app.js
...
//       } catch (error) {
//         tableStatus += `   ⚠️ ${table}: ${error.message}\n`;
...
//   try {
//     console.log('🔄 Starting Ikoota API server...');
    
//     // Test database connection first
//     const tableStatus = await testDatabaseConnection();
...
//       console.log(`   🗄️ Database Test: GET http://localhost:${PORT}/api/db-test`);
//       console.log('');
...
//       // Setup monitoring and graceful shutdown after successful startup
//       setupMonitoring();
//       gracefulShutdown();
