...
//   /*
// VERIFY in your main app.js that routes are mounted correctly:

// For frontend API calls using membershipApi with baseURL `/api/membership`:
// ✅ app.use('/api/membership', membershipRoutes);
// ✅ app.use('/api/membership/admin', membershipAdminRoutes);

// Your frontend api.js shows baseURL: 'http://localhost:3000/api'
// And membershipApi.js shows baseURL: `${API_BASE_URL}/membership`

// So full paths will be:
// - http://localhost:3000/api/membership/* (regular membership routes)
// - http://localhost:3000/api/membership/admin/* (admin membership routes)

// For survey admin routes:
...
// 2 User Admin Routes (Enhanced with Identity Admin) - MOUNT FIRST!
console.log('🔗 Mounting user admin routes at /users/admin...');
try {
  router.use('/users/admin', userAdminRoutes);
...
// 3 User Routes (Enhanced with Identity Management) - MOUNT AFTER ADMIN!
console.log('🔗 Mounting user routes at /users...');
try {
  router.use('/users', userRoutes);
...
// 7. Survey Admin Routes (already integrated)
console.log('🔗 Mounting survey admin routes at /survey/admin...');
try {
  router.use('/survey/admin', surveyAdminRoutes);
...
// 8. Survey Routes (already integrated)
console.log('🔗 Mounting survey routes at /survey...');
try {
  router.use('/survey', surveyRoutes);
