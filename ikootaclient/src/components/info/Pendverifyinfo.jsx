...
// // ikootaclient/src/components/info/Pendverifyinfo.jsx - FIXED TO STOP REDIRECT LOOP
// import React from 'react';
// import { useNavigate } from 'react-router-dom';
// import { useUser } from '../auth/UserStatus';
// import './pendverifyinfo.css';
...
//   // ✅ REMOVED THE PROBLEMATIC useEffect THAT CAUSED THE LOOP
//   // The redirect logic was causing infinite loops between components
//   // Let the user manually choose to complete the survey instead
...
//           {/* ✅ Show survey completion section only if not completed - NO AUTO REDIRECT */}
//           {!surveyCompleted && needsSurvey && (
//             <div className="incomplete-survey" style={{
//               background: '#fff3cd',
//               border: '1px solid #ffeaa7',
...
//               margin: '20px 0'
//             }}>
//               <h3 style={{ color: '#856404', marginTop: '0' }}>📋 Complete Your Application</h3>
//               <p style={{ color: '#856404' }}>
//                 <strong>Important:</strong> Your application survey is not yet complete. 
//                 To expedite your review process, please finish your application survey.
//               </p>
//               <button 
//                 onClick={() => {
//                   console.log('🔄 Manual navigation to application survey');
...
//                 Note: You can complete this at any time, but it may delay your review process.
//               </p>
//             </div>
//           )}
...
// // ikootaclient/src/components/info/Pendverifyinfo.jsx - FIXED VERSION
// import React from 'react';
// import { useNavigate } from 'react-router-dom';
// import { useUser } from '../auth/UserStatus';
// import './pendverifyinfo.css';
...
//   // ✅ IMPORTANT: If user still needs to complete survey, redirect them
//   React.useEffect(() => {
//     if (currentUserStatus === 'needs_application' && needsSurvey === true) {
//       console.log('🔄 User still needs to complete survey, redirecting...');
//       navigate('/applicationsurvey');
//     }
//   }, [currentUserStatus, needsSurvey, navigate]);
...
//           {/* ✅ Show survey completion section only if not completed */}
//           {!surveyCompleted && (
//             <div className="incomplete-survey">
//               <h3>📋 Complete Your Application</h3>
//               <p>
//                 To expedite your review process, please complete your application survey:
//               </p>
//               <button 
//                 onClick={() => navigate('/applicationsurvey')} 
//                 className="btn-primary"
...
//           <div className="action-buttons">
//             {/* ✅ FIXED: Allow access to public content and landing page */}
//             <button 
...
// const Pendverifyinfo = () => {
//   const navigate = useNavigate();
//   const { user, membershipStatus } = useUser();
