// ikootaclient/src/components/user/UserDashboard.jsx - FIXED API CALLS
...
const UserDashboard = () => {
  ...
  // ✅ FIXED: Queries with correct API endpoint
  const { data: dashboardData, isLoading, error } = useQuery({
    queryKey: ['userDashboard'],
    queryFn: fetchUserDashboard, // ✅ Now uses /user-status/dashboard
