...
//     checkApplicationStatus();
//   }, [isAuthenticated, navigate, loadSavedData]);
...
//       if (response.data.currentStatus?.initial_application_status !== 'not_submitted') {
//         // User has already submitted, clear saved data and redirect
//         clearSavedData();
//         navigate('/application-status');
//       }
...
//   // Same render functions as before...
//   const renderStep1 = () => (
//     <div className="survey-step">
//       <h3>📋 Personal Information</h3>
...
//     const fullURL = `${baseURL}/membership/survey/check-status`;
...
//     // If the response is HTML, log the beginning of it
//     if (error.response?.data && typeof error.response.data === 'string') {
//       console.error('❌ HTML Response (first 200 chars):', error.response.data.substring(0, 200));
//     }
    
//     // Try to parse what we actually got
//     try {
...
//       // Use your configured API service instead of direct fetch
//     const response = await api.post('/membership/survey/submit-application', {
//       answers,
//       applicationTicket: `APP-${user.username?.substring(0,3).toUpperCase()}-${Date.now().toString(36)}`
//     });
...
//     // Better error handling for axios responses
//     if (error.response) {
